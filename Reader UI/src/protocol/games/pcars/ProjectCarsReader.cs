...
{
    class ProjectCarsReader : SharedMemoryReader<ProjectCarsData.SharedMemory>
    {
        /* constructor */
        public ProjectCarsReader() : base("$pcars$", Marshal.SizeOf(typeof(ProjectCarsData.SharedMemory)))
        {
        }

        protected override ProjectCarsData.SharedMemory initDataStruct()
        {
            return new ProjectCarsData.SharedMemory();
        }

        protected override void writeCarValues(Car car, ProjectCarsData.SharedMemory data)
        {
            // Body
            ...
            car.ERSChargeLevel = data.BoostAmount;
        ...
        protected override void writeDriverValues(Driver driver, ProjectCarsData.SharedMemory data)
        {
        ...
        protected override void writeSessionValues(Session session, ProjectCarsData.SharedMemory data)
        {
